...
export const AWS_ACCESS_KEY_ID_LENS:string = process.env.AWS_ACCESS_KEY_ID_LENS || '';
export const AWS_SECRET_ACCESS_KEY_LENS:string = process.env.AWS_SECRET_ACCESS_KEY_LENS || '';
export const AWS_INSTANCE_ID:string = process.env.AWS_INSTANCE_ID || '';
export const AWS_DOMAIN_NAME:string = process.env.AWS_DOMAIN_NAME || '';